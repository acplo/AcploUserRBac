...
namespace AcploUserRbac\Mapper;

use ZfcBase\Mapper\AbstractDbMapper;
use ZfcUser\Entity\UserInterface;
use Zend\Stdlib\Hydrator\HydratorInterface;
use AcploUserRbac\Entity\UserRoleLinkerInterface;
...
class UserRoleLinkerMapper extends AbstractDbMapper implements UserRoleLinkerMapperInterface
{
     ...
     *
     * @param  AcploUserRbac\Entity\UserRoleLinkerInterface $userRoleLinker
     * @return mixed
     */
    ...
    /**
     * Checks if the provided entity is instance of AcploUserRbac\Entity\UserRoleLinkerInterface
     *
    ...
    protected function checkEntity($userRoleLinker)
    {
        if (!$userRoleLinker instanceof UserRoleLinkerInterface) {
            throw new Exception\InvalidArgumentException('Instance of AcploUserRbac\Entity\UserRoleLinkerInterface expected');
        }
    }
